//============================================================================
// STUDENT NAME: ZHANG YUXUAN
// NUS User ID.: t0916004
// COMMENTS TO GRADER: 
//
//============================================================================
...
void DrawSceneWithProjection()
{
	...
	// Read from ProjectorImage
	vec3 Color = vec3(textureProj(ProjectorImage, ShadowCoord));
	...
	vec3 diffuseColor = Color * MatlDiffuse * N_dot_L;
	vec3 specularColor = Color * MatlSpecular * R_dot_V_pow_n;

	// Shawdow mapping with PCF
	float sum = 0.0;
