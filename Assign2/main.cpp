...
static void MyDrawFunc(void)
{
	...
	//Position the box to the correct position
	modelMat0 = glm::translate(modelMat0, camWorldPos);
	//Scale the skycube to the size(skyboxSize*skyboxSize*skyboxSize)
	modelMat0 = glm::scale(modelMat0, vec3(skyboxSize, skyboxSize, skyboxSize));
